...
export const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute inset-0 grid-background bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p 
            className="text-xl md:text-2xl text-gray-600 mb-12 animate-fade-up" 
